...
**v0.6.0** — paradigm-drill exercises, diachronic paradigm tables through Modern Greek, clickable interactive text, stanza-match/translation-presence quizzes (balanced sampling, session-size caps, renew buttons), Byzantine lexicon rung, pronoun POS support, `magnify_image()` click-to-zoom images, more robust diacritics handling, README restructure, refactored `eee_topbar`.
